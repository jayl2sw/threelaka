...
const GuildMain = () => {
  ...
  console.log('myguildInfo', myGuildInfo);
  // useEffect
  useEffect(() => {
                ...
                {topThreeGuild.length !== 0 ? (
                  <>
                    <GradientCircleDiv
                      ...
                      fontSize={'2vmin'}
                      backgroundUrl={
                        topThreeGuild[0] && topThreeGuild[0].profile
                      }
                    ...
                    <GradientCircleDiv
                      ...
                      fontSize={'1vmin'}
                      backgroundUrl={
                        topThreeGuild[1] && topThreeGuild[1].profile
                      }
                      style={{ position: 'relative', marginRight: '2vw' }}
                    >
                      <FaCrown
                    ...
                    >
                      ...
                      >
                        ...
                        <FlexTransparentDiv
                          ...
                          IsBorder={'none'}
                          style={
                            myGuildInfo.notice && myGuildInfo.notice.length > 50
                              ? { fontSize: '2vmin' }
                              : { fontSize: '3vmin' }
                          }
                        >
